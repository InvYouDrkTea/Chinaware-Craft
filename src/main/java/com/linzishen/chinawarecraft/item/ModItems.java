package com.linzishen.chinawarecraft.item;
...
public class ModItems {
	...
	public static final Item COBALT_INGOT = new ItemBase("cobalt_ingot").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item WHITE_PORCELAIN_CLAY_BALL = new ItemBase("white_porcelain_clay_ball").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item PORCELAIN_SOIL = new ItemBase("porcelain_soil").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item IRON_OXIDE_POWDER = new ItemBase("iron_oxide_powder").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item CELADON_CLAY_BALL = new ItemBase("celadon_clay_ball").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item WHITE_VASES_PROTOTYPE = new ItemBase("white_vases_prototype").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item WHITE_DISH_PROTOTYPE = new ItemBase("white_dish_prototype").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item CELADON_VASES_PROTOTYPE = new ItemBase("celadon_vases_prototype").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
	public static final Item CELADON_DISH_PROTOTYPE = new ItemBase("celadon_dish_prototype").setCreativeTab(ModCreativeTab.CHIPMOD_ITEM);
